...
Route::prefix('/aluno')->group(function(){
    ...
    Route::get('/remove', [App\Http\Controllers\AlunoController::class, 'remove'])->name('aluno.remove');
}); 
...
Route::prefix('/curso')->group(function(){
    ...
    Route::get('/remove', [App\Http\Controllers\CursooController::class, 'remove'])->name('curso.remove');
}); 
...
Route::prefix('/professor')->group(function(){
    ...
    Route::get('/remove', [App\Http\Controllers\ProfessorController::class, 'remove'])->name('professor.remove');
}); 
